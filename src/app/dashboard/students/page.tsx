...
import { RiArrowDropDownLine, RiCheckboxBlankCircleLine, RiCheckboxBlankLine } from "react-icons/ri";
import { MdDelete, MdOutlineEmail } from 'react-icons/md';
import { SlOptionsVertical } from 'react-icons/sl';
import { FaArrowUp, FaBan, FaEye, FaRegCalendarAlt, FaSort, FaUserEdit } from 'react-icons/fa';
  ...
  <>
    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between px-6 py-4 border-b bg-white">
      <div>
        ...
        <div className="text-sm text-gray-500">
          Dashboard / Students / <span className="text-gray-900 font-medium"> All Students</span>
        </div>
      </div>
    ...
    <div className="bg-white rounded-lg shadow overflow-x-auto m-6">
      ...
      <div className="p-4 border-b flex items-center justify-between gap-2 flex-wrap">
        ...
        <button className=" border rounded-lg hover:bg-gray-100 px-3 py-2 gap-4 flex items-center"><FaRegCalendarAlt />
        15 July, 2025 - 13 August, 2025
        </button>
        <button className=" border rounded-lg hover:bg-gray-100 px-3 py-2 gap-0.5 flex items-center"><CiFilter />
        Filter
        <RiArrowDropDownLine className="text-black" />
        </button>
          ...
          {listOfStds.map((student, idx) => (
              <tr key={idx} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-blue-600 font-medium">
                  <Link href={`/students/${student.admissionNO}`}>{student.admissionNO}</Link>
                </td>
                ...
                <td className="px-4 py-3 flex space-x-2">
                  <button className="p-2 rounded hover:bg-gray-100"><FiSearch /></button>
                  <button className="p-2 rounded hover:bg-gray-100"><FiPhone /></button>
                  <button className="p-2 rounded hover:bg-gray-100"><MdOutlineEmail /></button>
